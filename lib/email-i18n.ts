...
const en: EmailStrings = {
  verifySubject: (c) => `${c} — Your Phantom Tracker verification code`,
  ...
  welcomeHi: (n) => (n ? `Hey ${n}, your account is verified — you're in. 🎉` : "Hey there, your account is verified — you're in. 🎉"),
  ...
  resetIgnore: "If you didn't request this, ignore this email — your password stays the same.",
  twoFASubject: (c) => `${c} — Your Phantom Tracker login code`,
  ...
  delLine1: (d, w) => `Your account is scheduled for permanent deletion. You have a ${d}-day grace period — change your mind any time before ${w} and everything is restored.`,
...
const hu: EmailStrings = {
  ...
  welcomeHi: (n) => (n ? `Szia ${n}, a fiókod megerősítve — bent vagy! 🎉` : "Szia, a fiókod megerősítve — bent vagy! 🎉"),
  ...
  delLine1: (d, w) => `A fiókod végleges törlésre van ütemezve. ${d} nap türelmi időd van — gondold meg bármikor ${w} előtt, és minden visszaáll.`,
...
const ro: EmailStrings = {
  verifySubject: (c) => `${c} — Codul tău de verificare Phantom Tracker`,
  ...
  welcomeHi: (n) => (n ? `Salut ${n}, contul tău e verificat — ești înăuntru! 🎉` : "Salut, contul tău e verificat — ești înăuntru! 🎉"),
  ...
  resetIgnore: "Dacă nu ai cerut asta, ignoră acest e-mail — parola rămâne aceeași.",
  twoFASubject: (c) => `${c} — Codul tău de conectare Phantom Tracker`,
  ...
  delLine1: (d, w) => `Contul tău e programat pentru ștergere definitivă. Ai o perioadă de grație de ${d} zile — răzgândește-te oricând înainte de ${w} și totul e restaurat.`,
